...
HELP_BUILDS = "Expand all possible statuses related to builds (success, failure and aborted)"
HELP_TIMING= "Expand all execution times for builds (queued, running and total)"
